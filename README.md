TheExttendについて
TheExtendは、M5StackCore2（ESP32）と自作キーボード(QMKFirmware/RP2040Zero)及びPCを接続して使用する拡張基板及び自作のアプリケーションです。
基本構成として自作キーボードとI2C通信を行うStructure_1とPCを介してUSBシリアル及びRawHIDを使用するStructure_2があります。
